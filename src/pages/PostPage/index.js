...
function PostPage() {
    ...
    return(
      <>
        <div className="btnsContainer">
          <div className="btn backBtn" onClick={() => onClickEdit()}>Back to post</div>
        </div>
  ...
  return (
    <>
      <div className="btnsContainer">
        <Link to="/" className="btn btnBackToList">Back to list</Link>
        <div className="btn backBtn" onClick={() => onRemovePost(id)}>Remove</div>
        <div className="btn editBtn" onClick={() => onClickEdit()}>Edit</div>
      </div>
